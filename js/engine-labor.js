...
(function (global) {
  ...
  var SPLH_TARGET = { camino: 96, star: 101, catos: 88, bnn: 91 };
  /* back-of-house share of hours */
  var BOH_SHARE = { camino: 0.46, star: 0.52, catos: 0.44, bnn: 0.45 };

  /* how hours split inside each half of the house */
  var FOH_MIX = { server: 0.42, bartender: 0.20, host: 0.13, busser: 0.25 };
  var BOH_MIX = { line: 0.46, prep: 0.22, dish: 0.22, sous: 0.10 };
