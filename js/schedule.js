...
(function (global) {
  ...
  var JOB_FAMILY = {
    server: 'foh', bartender: 'bar', host: 'foh', busser: 'foh',
    line: 'boh', prep: 'boh', dish: 'dish', sous: 'boh', mgr: 'mgr'
  };
  var FAMILY_COLOR = {
    foh:  '#2766d6', bar: '#e87ba4', boh: '#eb6834',
    dish: '#1baf7a', mgr: '#eda100'
  };
  var FAMILY_LABEL = { foh: 'Front of house', bar: 'Bar', boh: 'Kitchen', dish: 'Dish', mgr: 'Management' };
