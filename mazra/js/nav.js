...
var NAV_GROUPS = [
  { id: 'home', label: 'Home', href: '/hospitality/mazra/', items: [] },
  { id: 'today', label: 'Today', href: '/hospitality/mazra/today', items: [] },
  {
    id: 'analyze', label: 'Analyze',
    items: [
      { href: '/hospitality/mazra/explore', label: 'KPI Explorer' },
      { href: '/hospitality/mazra/analyze', label: 'Cross-Analysis' }
    ]
  },
  {
    id: 'sales', label: 'Sales',
    items: [
      { href: '/hospitality/mazra/sales',    label: 'Sales & Traffic' },
      { href: '/hospitality/mazra/menu',     label: 'Menu Engineering' },
      { href: '/hospitality/mazra/covers',   label: 'Reservations & Covers' },
      { href: '/hospitality/mazra/offprem',  label: 'Off-Premise Economics' }
    ]
  },
  {
    id: 'cost', label: 'Cost', perm: 'margins',
    items: [
      { href: '/hospitality/mazra/cogs',      label: 'Food & Beverage Cost' },
      { href: '/hospitality/mazra/purchasing', label: 'Purchasing & Price Watch' },
      { href: '/hospitality/mazra/inventory', label: 'Inventory & Waste' }
    ]
  },
  {
    id: 'people', label: 'People',
    items: [
      { href: '/hospitality/mazra/labor',  label: 'Labor & Scheduling' },
      { href: '/hospitality/mazra/hr',     label: 'People & HR' }
    ]
  },
  {
    id: 'guest', label: 'Guest',
    items: [
      { href: '/hospitality/mazra/guest',     label: 'Experience & Reputation' },
      { href: '/hospitality/mazra/marketing', label: 'Marketing & Loyalty' }
    ]
  },
  {
    id: 'finance', label: 'Financial', perm: 'money',
    items: [
      { href: '/hospitality/mazra/finance',  label: 'P&L by Unit' },
      { href: '/hospitality/mazra/forecast', label: 'Forecast & Growth' },
      { href: '/hospitality/mazra/cash',     label: 'Cash & Loss Prevention' },
      { href: '/hospitality/mazra/leases',   label: 'Real Estate & Leases' }
    ]
  },
  {
    id: 'ops', label: 'Operations',
    items: [
      { href: '/hospitality/mazra/facilities',   label: 'Facilities & Energy' },
      { href: '/hospitality/mazra/compliance',   label: 'Food Safety & Compliance' },
      { href: '/hospitality/mazra/integrations', label: 'Integrations & Data Health' }
    ]
  }
];
...
var TICKER = [
  ['LAMB (USDA)', '$8.24/lb', '+12.8% YoY', 'down'],
  ['CHICKEN THIGH', '$1.42/lb', '+4.1% YoY', 'down'],
  ['CHICKPEAS', '$1.42/lb', '+3.6% YoY', 'down'],
  ['TAHINI', '$4.90/lb', '+6.2% YoY', 'down'],
  ['OLIVE OIL', '$42.80/gal', '+18.4% YoY', 'down'],
  ['GREEN COFFEE (ICE)', '$3.18/lb', '+14.0% YoY', 'down'],
  ['PRODUCE INDEX', '104.3', '+2.2%', 'down'],
  ['CPI FOOD AWAY FROM HOME', '+3.9% YoY', 'unch', 'down'],
  ['CA MINIMUM WAGE', '$16.50/hr', 'eff. 01-01', 'down'],
  ['SAN MATEO CO. MIN WAGE', '$17.35/hr', 'eff. 01-01', 'down'],
...
var MARQUEE = [
  ['MAZRA', 'Two restaurants, one connected operating system'],
  ['MAZRA', 'Ranked #23 on Yelp’s Top 100 Places to Eat in the US — the highest-placed Bay Area restaurant'],
  ['COMMODITY', 'Lamb up 12.8% year over year and olive oil up 18.4% — the two lines that move this menu most'],
  ['NO ALCOHOL', 'Beverage margin comes from the cafe program, not a bar — see Menu Engineering'],
  ['CA LABOR', 'San Mateo County minimum wage runs above the state floor; break premiums tracked per shift'],
  ['MAZRA', 'Period close runs on a 13-period calendar — every period is four comparable weeks']
];
...
function renderTopbar(opts) {
  ...
  target.outerHTML =
    ...
    '<div class="portal-topbar">' +
      '<a class="brand" href="/hospitality/mazra/" style="cursor:pointer;text-decoration:none">' +
        '<img src="/hospitality/mazra/assets/brand/mazra-mark.svg" alt="' + esc(RG.COMPANY.name) + '" class="rg-logo">' +
...
(function loadStickyHscroll() {
  ...
  s.src = '/hospitality/mazra/js/sticky-hscroll.js';
  s.async = true;
