...
(function (global) {
  ...
  var periodGuest = R.memo(function (unitId, periodKey) {
    ...
    /* Mazra was ranked #23 on Yelp's Top 100 Places to Eat in the US, so the
       baseline is genuinely high — the interesting question is what pulls it
       DOWN on a bad week, not whether it is good. */
    var base = { mazra: 4.62 }[u.brand];
