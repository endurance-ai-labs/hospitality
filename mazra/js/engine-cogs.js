...
(function (global) {
  ...
  function driverRates(unitId, periodKey) {
    ...
    /* The newer restaurant runs hotter on variance while the team trains in;
       San Bruno, five years in, is the control. */
    var hot = unitId === 'mz-rwc';
    var clean = unitId === 'mz-sb';
