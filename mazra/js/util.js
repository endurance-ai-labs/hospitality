...
function renderSignIn() {
  ...
  ov.innerHTML =
    '<div class="login-box">' +
      '<img src="/hospitality/mazra/assets/brand/mazra-wordmark.svg" alt="' + esc(RG.COMPANY.name) + '" class="login-logo">' +
...
function slackNudge(key, i) {
  ...
  pop.innerHTML =
    '<div class="slk-win">' +
      '<div class="slk-head">' + slackMark() + '<b>Mazra</b><span>Direct message</span>' +
